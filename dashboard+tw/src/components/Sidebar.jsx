...
import {ArrowUpIcon, BellIcon, CreditCardIcon, DocumentSearchIcon, ExternalLinkIcon, HomeIcon, MailIcon} from '@heroicons/react/solid'
...
const Sidebar = () => {
  return (
    <div className='bg-slate-800 flex-none w-14 sm:w-20 h-screen'>
        ...
        <div className='fixed left-3 sm:left6 top-[100px]'>
        ...
        <div className='fixed bottom-4 left-3 sm:left6'>
            <a href='#top'>
